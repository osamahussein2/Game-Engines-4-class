...
public:
	...
	bool IsBoxVisible(Model* model_, const glm::vec3& minp, const glm::vec3& maxp) const;
...
inline bool Frustum::IsBoxVisible(Model* model_, const glm::vec3& minp, const glm::vec3& maxp) const
{
	...
	if (out == 8) { std::cout << "NOT RENDERING" << std::endl; return false; }
